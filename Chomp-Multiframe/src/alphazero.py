...
class AlphaZeroParallel:
    ...
    def selfPlay(self):
        ...
        while len(spGames) > 0:
            ...
            for i in range(len(spGames))[::-1]:
                ...
                encoded = self.game.get_encoded_state([spg.history[-3:]])[0]
                spg.memory.append((encoded, action_probs, player))
                ...
                spg.history.append(spg.state.copy())
    ...
    def train(self, memory):
        ...
        for batchIdx in range(0, len(memory), self.args['batch_size']):
            ...
            if batchIdx % self.args['log_freq'] == 0:
                wandb.log({
